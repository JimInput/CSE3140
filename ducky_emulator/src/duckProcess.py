...
def KeyboardAction(command:str, keys:str):
    ...
    try:
        match command:
            ...
            case "COMMAND" | "WINDOWS" | "GUI" | "ENTER" | "APP" | "MENU" | "SHIFT" | "ALT" | "CONTROL" | "CTRL":
                CheckDefaultSleep()
                SimulateModifiedKeyStroke(command, keys)
            case "ESCAPE" | "ESC" | "TAB" | "DELETE" | "SPACE" | "DOWNARROW" | "DOWN" | "LEFTARROW" | "LEFT" | "RIGHTARROW" | "RIGHT" | "UPARROW" | "UP":
                CheckDefaultSleep()
